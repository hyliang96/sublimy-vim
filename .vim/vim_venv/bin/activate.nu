...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/mac/Documents/shareENV/app_config/vim/.vim/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/mac/Documents/shareENV/app_config/vim/.vim/venv/bin/deactivate.nu'
